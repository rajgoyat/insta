...
import login1 from "./Imgs/loginimage1.png";
import loginimage from "./Imgs/loginimage.png";
import login2 from "./Imgs/loginimage2.png";
import login3 from "./Imgs/loginimage3.png";
import login4 from "./Imgs/loginimage4.png";
...
const Login = () => {
  ...
  return (
    ...
    >
      <ImageContent />
      <div style={{ width: "350px", height: "604px" }}>
        <div
          className="border border-1 mb-2"
          style={{ height: "405px", width: "350px" }}
        >
          ...
          <div
            className="d-flex align-items-center flex-column loginPageForm justify-content-center"
            style={{ widht: "268px" }}
          >
            <form
            ...
            <div className="d-flex align-items-center justify-content-center mt-5">
              ...
              />
              <div className="text-primary ms-2">Login with Facebook</div>
            </div>
            <p
 ...
 const images= [login1, login2,login3,login4]
  ...
  useEffect(() => {
    ...
    const interval =setInterval(() => {
      setLoginImg(images[indx])
if(indx===3){setindx(0)}else{setindx(indx+1)}
    }, 3000);

    return () => clearInterval(interval); // Cleanup function to clear interval on component unmount
  }, [indx]); // Empty dependency array ensures useEffect runs only once after initial render


  return (
    <div
      className="loginImage position-relative me-5"
      style={{ height: "604.01px", width: "412.9 9px" }}
    >
      <img
        src={loginImg}
        alt="yurtuir"
