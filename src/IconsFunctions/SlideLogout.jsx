...
export const SlideLogout = ()=>{
  ...
  const handleLogOut= async()=>{
   ...
   if(logout){navigate('/insta-app/login');} 
    ...
    return(<div className='collapse slidelogoutIconmain'> <div className=" slidelogoutIcon position-absolute bg-white d-flex flex-column  justify-content-evenly" style={{height:"404px", width:"266px", bottom:"50px",left:"55px", boxShadow:"0 0 10px 2px rgba(43, 41, 41, 0.274)",borderRadius:"20px"}}>
      ...
      <div><div className='set' style={{margin:"4px", padding:"6px"}} onClick={handleLogOut}>Logout</div></div>
