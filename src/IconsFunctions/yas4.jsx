...
export default function SearchFollowing({userIdd}) {
  ...
  const handleFollow = async (event, userToFollow) => {
    ...
    return (
        <>
            <div className={`${Sfollowing ? "" : "d-none"} w-100 bg- DALJU position-absolute top-0`} onClick={() => SsetFollowing(false)} style={{ height: "100vh", background: "rgba(0,0,0,0.65)", zIndex: "1001" }}>
