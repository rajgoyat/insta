...
export default function FollowersPage() {
    ...
    return (
        <>
            <div className={`${follower ? "" : "d-none"} w-100 bg- DALJU position-absolute top-0`} onClick={() => setFollower(false)} style={{ height: "100vh", background: "rgba(0,0,0,0.65)", zIndex: "1001" }}>
