...
if(!profile){
  ...
  return (
    <>
    <div>
        {showLoading &&(<div className=" w-100 d-flex align-items-center justify-content-center " style={{height:"100%", zIndex:"20",background:"#00000000"}}> 
  ...
  /></div></div>)}
        <form action="" className="position-relative" onSubmit={updateUserData}>
          <div className="position-relative " style={{ padding: "0px 50px 0 50px" }}>
            <div className=" mb-4 mt-3" style={{ padding: "12px 0px" }}>
              {" "}
              <h2
